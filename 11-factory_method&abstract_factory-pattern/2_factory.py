'''
Let's think about discoverability. 
How does the client know that there is now a factory that they can use?
1. make documentation well
2. separate class
'''
...
class Point:
    ...
    # static fashion - singleton instance of point factory
    factory = Factory()
